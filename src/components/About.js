  ...
  return (
    ...
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <p class="mb-8 leading-relaxed text-lg">
            I'm in my final year at Cal State Fullerton and is currently pursuing a degree in Computer Science. Within Computer Science, I want to pursue a career in Software Engineer and/or Front End Web Development. I am open to any opportunities.
        </p>
